...
!!
!! TEMPLATE:
!! This is a template that is expected to work with most models. Possible
!! adaption should only be done at those places marked with 'TEMPLATE'.
!! Please note:
...
! +++ TEMPLATE: 
! +++ Adapt the specification of COMM_ensemble, npes_ens
! +++ and mype_ens, if the model uses a communicator that
! +++ is different from MPI_COMM_WORLD, thus not containing
