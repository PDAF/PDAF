!$Id: likelihood_hyb_l_pdaf.F90 1075 2023-02-13 18:56:39Z lnerger $
!> Compute local likelihood for an ensemble member using hybrid weight
!!
!! The routine is called during the analysis step
!! of the localized hybrid filter LKNETF.
...
!! * 2023-03 - Lars Nerger - Initial code based on prodRinvA_l_pdaf
...
! *** local variables ***
  ...
  WRITE (*,*) 'TEMPLATE likelihood_hyb_l_pdaf.F90: Compute likelihood with localization here!'
...
! ********************
  ...
  DO i = 1, dim_obs_l
     Rinvresid_l(i) = (1.0-gamma) * ivariance_obs * weight(i) * resid_l(i)
  END DO
...
END SUBROUTINE likelihood_hyb_l_pdaf
