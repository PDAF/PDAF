...
!
!
!> PDAF-internal initialization of parameters for DA method LOCALTEMPLATE
!!
...
!! considered.
!! When implemeting for a new DA method, you should replace 'LOCALTEMPLATE'
...
!!
SUBROUTINE PDAF_LOCALTEMPLATE_init(subtype, param_int, dim_pint, param_real, dim_preal, &
...
! +++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  filter_pe2: IF (verbose > 0) THEN
     ...
     WRITE(*, '(/a, 4x, a)') 'PDAF', '++++++++++++++++++++++++++++++++++++++++++++++++++++++++'
     WRITE(*, '(a, 4x, a)')  'PDAF', '+++       TEMPLATE FOR CALALTEMPLATE DA METHOD       +++'
     WRITE(*, '(a, 4x, a)')  'PDAF', '+++ replace this string upon implementing the method +++'
     WRITE(*, '(a, 4x, a)')  'PDAF', '++++++++++++++++++++++++++++++++++++++++++++++++++++++++'

     ! *** General output ***
     WRITE (*, '(/a, 4x, a)') 'PDAF', 'LOCALTEMPLATE configuration'
     WRITE (*, '(a, 10x, a, i1)') 'PDAF', 'sub-type = ', subtype
     IF (subtype == 0) THEN
        WRITE (*, '(a, 12x, a)') 'PDAF', '--> LOCALTEMPLATE subtype 0'
     ELSE IF (subtype == 1) THEN
        WRITE (*, '(a, 12x, a)') 'PDAF', '--> LOCALTEMPLATE subtype 1'
