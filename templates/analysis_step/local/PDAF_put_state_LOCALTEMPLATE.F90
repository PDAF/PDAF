...
!!
MODULE PDAFput_state_LOCALTEMPLATE

CONTAINS

  SUBROUTINE PDAF_put_state_LOCALTEMPLATE(U_collect_state, &
...
!   variables are kept unchanged
          CALL PDAFLOCALTEMPLATE_update(step_obs, dim_p, dim_obs, dim_ens, &
               state, Ainv, ens, U_init_dim_obs, U_obs_op, U_init_obs, &
               U_init_n_domains_p, U_init_dim_l, U_g2l_state, U_l2g_state, &
               U_init_dim_obs_l, U_g2l_obs, U_init_obs_l, U_prodRinvA_l, &
...
END MODULE PDAFput_state_LOCALTEMPLATE
