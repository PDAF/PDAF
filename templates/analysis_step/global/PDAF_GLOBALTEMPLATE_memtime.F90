...
!! memory information for your GLOBALTEMPLATE DA method.
!!
...
! +++ TEMPLATE: Add method-specific timers here
...
! ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     ! Generic part
     WRITE (*, '(//a, 21x, a)') 'PDAF', 'PDAF Timing information - second-level'
     WRITE (*, '(a, 10x, 45a)') 'PDAF', ('-', i=1, 45)
...
! +++ TEMPLATE: Add method-specific timers here
        ...
        WRITE (*, '(a, 23x, a, F11.3, 1x, a)') 'PDAF', 'analysis step (3):', pdaf_time_tot(3), 's'
...
! ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     ! Generic part
     WRITE (*, '(//a, 21x, a)') 'PDAF', 'PDAF Timing information - maximum detail'
     WRITE (*, '(a, 10x, 45a)') 'PDAF', ('-', i=1, 45)
     WRITE (*, '(a, 21x, a, F11.3, 1x, a)') 'PDAF', 'Initialize PDAF (1):', pdaf_time_tot(1), 's'
     IF (.not.offline_mode) THEN
        IF (subtype_filter<2) THEN
