...
!! PE-local  sub-domain. (init_obsvar_l_B is the 
...
!! domain.  (See init_obsvar_B for a global variant)
!!
!! The implemented functionality is generic. There
!! should be no changes required as long as the
!! observation error covariance matrix is diagonal.
...
!! The routine is called by all filter processes.
!!
  SUBROUTINE prodRinvA_B(ncol, A_p, C_p)
...
!! The routine is called by all filter processes.
!!
  SUBROUTINE add_obs_error_B(dim_obs, C_p)
...
! ***********************************************
  ...
  END SUBROUTINE add_obs_error_B
...
!! The routine is called by all filter processes.
!!
  SUBROUTINE init_obscovar_B(dim_obs, covar, isdiag)
...
! ***********************************************
  ...
  END SUBROUTINE init_obscovar_B
...
!! The routine is called by all filter processes.
!!
  SUBROUTINE likelihood_B(dim_obs, obs, resid, lhood)
...
!! assumed observation error statistics.
!!
  SUBROUTINE likelihood_l_B(verbose, dim_obs_l, obs_l, resid_l, &
...
!!
  SUBROUTINE localize_covar_B(verbose, dim, dim_obs, &
