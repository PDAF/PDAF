...
!BOP
!
! !ROUTINE: PDAF_assimilate_prepost_si --- Interface to transfer state to PDAF
!
! !INTERFACE:
SUBROUTINE PDAF_assimilate_prepost_si(outflag)
...
! **************************************************
  ...
  CALL PDAF_assimilate_prepost(collect_state_pdaf, distribute_state_pdaf, &
