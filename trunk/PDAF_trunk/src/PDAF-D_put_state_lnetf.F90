...
!
!$Id: PDAF-D_put_state_lnetf.F90 1674 2016-12-02 10:47:04Z lnerger $
!BOP
!
! !ROUTINE: PDAF_put_state_lnetf --- Interface to transfer state to PDAF
!
! !INTERFACE:
  ...
  completeforecast: IF (member == local_dim_ens + 1 &
     ...
     OnFilterPE: IF (filterpe) THEN
        ...
        CALL  PDAF_lnetf_update(step_obs, dim_p, dim_obs, dim_ens, &
             state, eofU, eofV, type_forget, forget, &
