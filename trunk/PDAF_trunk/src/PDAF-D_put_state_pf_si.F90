...
!
!$Id: PDAF-D_put_state_pf_si.F90 27 2018-03-09 20:04:05Z lnerger $
!BOP
!
! !ROUTINE: PDAF_put_state_pf_si --- Interface to transfer state to PDAF
!
! !INTERFACE:
SUBROUTINE PDAF_put_state_pf_si(outflag)
