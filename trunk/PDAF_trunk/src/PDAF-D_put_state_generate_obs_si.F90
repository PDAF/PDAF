...
!
!$Id: PDAF-D_put_state_etkf_si.F90 27 2018-03-09 20:04:05Z lnerger $
!BOP
!
! !ROUTINE: PDAF_put_state_generate_obs_si --- Interface to transfer state to PDAF
!
! !INTERFACE:
SUBROUTINE PDAF_put_state_generate_obs_si(outflag)
...
! ! Names of external subroutines 
  EXTERNAL :: collect_state_pdaf, & ! Routine to collect a state vector
       init_dim_obs_f_pdaf, &       ! Initialize dimension of observation vector
       obs_op_f_pdaf, &             ! Observation operator
       get_obs_f_pdaf, &            ! Initialize observation vector
       init_obserr_f_pdaf, &        ! Initialize mean observation error variance
...
! **************************************************
  ...
  CALL PDAF_put_state_generate_obs(collect_state_pdaf, init_dim_obs_f_pdaf, obs_op_f_pdaf, &
       get_obs_f_pdaf, init_obserr_f_pdaf, prepoststep_pdaf, outflag)
