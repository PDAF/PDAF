...
!
!$Id: PDAF-D_gather_obs_f.F90 1856 2017-12-06 08:36:03Z lnerger $
!BOP
!
...
#include "typedefs.h"
  ...
  USE PDAF_mod_filtermpi, &
       ONLY: COMM_filter, MPI_REALTYPE, MPIerr, mype_filter, &
       all_dim_obs_p, all_dis_obs_p, dimobs_p, dimobs_f, npes_filter
