!$Id: init_obs_pdaf.F90 1249 2012-01-27 13:44:54Z lnerger $
!BOP
!
...
! ******************************
  ...
  ! generation.
   ...
   END IF mype0
     ...
     ALLOCATE(observation(dim_obs_p))
     ...
     CALL dlarnv(3, iseed, dim_obs_p, obs_errors(1 : dim_obs_p))
