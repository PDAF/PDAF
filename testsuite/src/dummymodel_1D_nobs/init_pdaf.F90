!$Id: init_pdaf.F90 1871 2017-12-22 09:17:27Z lnerger $
!BOP
!
...
! !USES:
  USE mod_model, &        ! Model variables
       ONLY: step_null, dim_state, dim_state_p, dt, local_dims
  USE mod_parallel, &     ! Parallelization variables
       ONLY: mype_world, n_modeltasks, task_id, npes_model, &
  ...
  USE mod_assimilation, & ! Variables for assimilation
       ...
       local_range, srange, int_rediag, filename, type_trans, dim_obs_p, &
       type_sqrt, local_dims_obs
...
! *** specifications for observations ***
  ...
  dim_obs_p = dim_state_p  ! All grid points are observed
