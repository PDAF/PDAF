!$Id: mod_assimilation.F90 1548 2015-01-17 09:22:02Z lnerger $
!BOP
!
! !MODULE:
...
! ! Settings for observations - available as command line options
  ...
  INTEGER :: dim_obs_p     ! Number of observations per process
...
!    ! Other variables - _NOT_ available as command line options!
  INTEGER(kind=8) :: dim_obs       ! Global number of observations
