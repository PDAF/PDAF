!$Id: init_pdaf_parse.F90 1548 2015-01-17 09:22:02Z lnerger $
!BOP
!
...
! !USES:
  ...
  USE mod_assimilation, & ! Variables for assimilation
       ...
       srange, int_rediag, filename, type_trans, dim_obs_p, &
       type_sqrt
...
! **********************************
  ...
  handle = 'dim_obs_p'               ! Number of observations
  CALL parse(handle, dim_obs_p)
