!$Id: init_seik_dist_pdaf.F90 1711 2016-12-20 10:17:58Z lnerger $
!BOP
!
! !ROUTINE: init_seik_dist_pdaf --- Initialize distributed ensemble
!
! !INTERFACE:
SUBROUTINE init_seik_dist_pdaf(filtertype, dim_p, dim_ens, state_p, Uinv, &
     ens_p, flag)
...
! *************************************************
  ...
  END IF
  CALL sgemm('n', 't', dim_p, rank + 1, rank, &
...
END SUBROUTINE init_seik_dist_pdaf
