!$Id: obs_op_dummy3d_D.F90 783 2009-12-07 10:28:43Z lnerger $
!BOP
!
...
! *********************************************
  ...
  ! For the dummy model the observation operator takes the first dim_obs_p elements
  m_state_p(1:dim_obs_p) = state_p(1:dim_obs_p)
