...
!BOP
!
! !ROUTINE: PDAFomi_assimilate_lenkf_si --- Interface to transfer state to PDAF
!
! !INTERFACE:
SUBROUTINE PDAFomi_assimilate_lenkf_si(outflag)
...
! Calls: PDAFomi_assimilate_lenkf
!EOP
...
CALL PDAFomi_assimilate_lenkf(collect_state_pdaf, distribute_state_pdaf, &
     ...
     localize_covar_pdafomi, next_observation_pdaf, outflag)
