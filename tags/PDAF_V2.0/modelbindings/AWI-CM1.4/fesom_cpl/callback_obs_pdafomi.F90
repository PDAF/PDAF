!$Id: callback_obs_pdafomi.F90 454 2020-05-24 08:44:09Z lnerger $
...
SUBROUTINE obs_op_pdafomi(step, dim_p, dim_obs, state_p, ostate)
  ...
  ! Include functions for different observations
  USE obs_sst_cmems_pdafomi, ONLY: obs_op_sst
...
SUBROUTINE init_dim_obs_l_pdafomi(domain_p, step, dim_obs, dim_obs_l)
  ...
  USE obs_sst_cmems_pdafomi, ONLY: init_dim_obs_l_sst
...
SUBROUTINE deallocate_obs_pdafomi(step)
  ...
  ! Include observation types
  USE obs_sst_cmems_pdafomi, ONLY: deallocate_obs_sst
