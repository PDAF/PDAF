!$Id: obs_op_f_pdaf.F90 1711 2016-12-20 10:17:58Z lnerger $
!BOP
!
...
! !USES:
  USE mod_parallel, &
       ONLY: npes_filter, COMM_filter, MPIerr, MPI_REAL
  USE mod_model, &
...
! *********************************************
  ...
  CALL MPI_AllGatherV(state_p, dim_p, MPI_REAL, &
       mstate_gather, local_dims, local_dis, MPI_REAL, &
       COMM_filter, MPIerr)
