...
!! The routine is called by all filter processes.
!!
  SUBROUTINE prodRinvA_TYPE(ncol, A_p, C_p)
...
!! The routine is called by all filter processes.
!!
  SUBROUTINE add_obs_error_TYPE(dim_obs, C_p)
...
! ***********************************************
  ...
  END SUBROUTINE add_obs_error_TYPE
...
!! The routine is called by all filter processes.
!!
  SUBROUTINE init_obscovar_TYPE(dim_obs, covar, isdiag)
...
! ***********************************************
  ...
  END SUBROUTINE init_obscovar_TYPE
...
!! The routine is called by all filter processes.
!!
  SUBROUTINE likelihood_TYPE(dim_obs, obs, resid, lhood)
...
! **************************
  ...
  END SUBROUTINE likelihood_TYPE
...
!! assumed observation error statistics.
!!
  SUBROUTINE likelihood_l_TYPE(verbose, dim_obs_l, obs_l, resid_l, &
...
! **************************
  ...
  END SUBROUTINE likelihood_l_TYPE
...
!!
  SUBROUTINE localize_covar_TYPE(verbose, dim, dim_obs, &
