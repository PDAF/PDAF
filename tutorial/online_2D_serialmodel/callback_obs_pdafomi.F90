...
!!
!! This routine is executed at the analysis time. 
!! For asynchronous DA, this routine calls the
!! observation-specific routines init_dim_obs_async_TYPE.
!!
SUBROUTINE init_dim_obs_async_pdafomi(step, dim_obs)
