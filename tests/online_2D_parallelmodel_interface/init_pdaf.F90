...
! *** External subroutines ***
  PROCEDURE(init_ens) :: init_ens_pdaf
  PROCEDURE(next_observation) :: next_observation_pdaf
  PROCEDURE(distribute_state) :: distribute_state_pdaf
  PROCEDURE(prepoststep) :: prepoststep_pdaf
...
! **********************************
  ...
  CALL PDAFget_state(steps, timenow, doexit, next_observation_pdaf, &
