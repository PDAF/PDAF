...
DA_SPECS=" -dim_ens 4 -forget 0.8 -screen 1 -cradius 5.0 -locweight 2 -delt_obs 2 -dim_lag 10"
...
then
    ...
    $RUNSTR $DA_SPECS  -filtertype $FTYPE -subtype $STYPE > ../out.smoother_2D_filter${FTYPE}s${STYPE}
    cd ..
    python verification/check_smoother2.py online_2d_parallelmodel smoother_2D_ftype${FTYPE}s${STYPE}
...
then
    ...
    $RUNPAR $DA_SPECS  -filtertype $FTYPE -subtype $STYPE > ../out.smoother_2D_par_filter${FTYPE}s${STYPE}
    cd ..
    python verification/check_smoother2.py online_2d_parallelmodel smoother_2D_ftype${FTYPE}s${STYPE}
