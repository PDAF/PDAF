!$Id: init_ens_rnd.F90 831 2021-11-06 16:16:30Z lnerger $
!BOP
!
...
!
! This version is for the Lorenz05c model
...
! *** Read states according to rnd_indx to initialize ensemble
  ...
  DO i = 1, dim_ens
     ...
     cnt(1) = dim
     s = s + 1
     stat(s) = NF90_GET_VAR(fileid, id_state, ens(:, i), start=pos, count=cnt)
