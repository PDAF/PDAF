...
!       square-root filters.
! ens - By reading an ensemble generated by
!       a previous assimilation run
...
! **********************
  ...
  ELSE IF (TRIM(type_ensinit) == 'ens') THEN
     ! Initialize by reading an ensemble from an assimilation run
     CALL init_ens_ens(dim, dim_ens, state, ens, flag)
