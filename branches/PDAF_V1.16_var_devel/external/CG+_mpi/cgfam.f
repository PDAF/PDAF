...
C
C     MPI-parallelization by Phil Browne, University of Reading
C
C     --------------------------------------------------------------------
C
      SUBROUTINE CGFAM_mpi(N,X,F,G,D,GOLD,IPRINT,EPS,W,
...
C       MAXFEV BY THE END OF AN ITERATION.
      ...
      MAXFEV= 40
C
      IF(IPRINT(1).GE.0) CALL CGBD_mpi(IPRINT,ITER,NFUN,
...
C
      CALL CVSMOD_mpi(N,X,F,G,D,STP,FTOL,GTOL,
...
C
C**************************************************************************
      SUBROUTINE CGBD_mpi(IPRINT,ITER,NFUN,
     *           GNORM,N,X,F,G,STP,FINISH,NDES,IM,BETAFR,BETAPR,BETA)
C
C     ---------------------------------------------------------------------
