...
!BOP
!
! !ROUTINE: PDAF_3dvar_costf_cg_cvt_hyb --- Evaluate cost function, its gradient and Hessian
!
! !INTERFACE:
SUBROUTINE PDAF_3dvar_costf_cg_cvt_hyb(step, iter, dim_p, dim_ens, &
...
END SUBROUTINE PDAF_3dvar_costf_cg_cvt_hyb
