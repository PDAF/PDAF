...
!BOP
!
! !ROUTINE: PDAF_put_state_en3dvar --- Interface to transfer state to PDAF
!
! !INTERFACE:
SUBROUTINE PDAF_put_state_en3dvar(U_collect_state, U_init_dim_obs, U_obs_op, &
...
! ********************************************************
  completeforecast: IF (member == local_dim_ens + 1 &
     ...
     OnFilterPE: IF (filterpe) THEN
        ...
        CALL PDAF_en3dvar_update(step_obs, dim_p, dim_obs, dim_ens, &
...
END SUBROUTINE PDAF_put_state_en3dvar
