C
C
      SUBROUTINE CVSMOD_mpi(N,X,F,G,S,STP,FTOL,GTOL,XTOL,
...
C
            CALL CSTEPM_mpi(STX,FXM,DGXM,STY,FYM,DGYM,STP,FM,DGM,
...
C           AND TO COMPUTE THE NEW STEP.
C
            CALL CSTEPM_mpi(STX,FX,DGX,STY,FY,DGY,STP,F,DG,
     *                 BRACKT,STMIN,STMAX,INFOC)
            END IF
C
...
C
      END
      SUBROUTINE CSTEPM_mpi(STX,FX,DX,STY,FY,DY,STP,FP,DP,BRACKT,
     *                 STPMIN,STPMAX,INFO)
      INTEGER INFO
