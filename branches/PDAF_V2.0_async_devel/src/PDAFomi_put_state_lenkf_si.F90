...
!BOP
!
! !ROUTINE: PDAFomi_put_state_lenkf_si --- Interface to transfer state to PDAF
!
! !INTERFACE:
SUBROUTINE PDAFomi_put_state_lenkf_si(outflag)
...
! **************************************************
  ...
  CALL PDAFomi_put_state_lenkf(collect_state_pdaf, init_dim_obs_pdafomi, &
       obs_op_pdafomi, prepoststep_pdaf, localize_covar_pdafomi, outflag)
