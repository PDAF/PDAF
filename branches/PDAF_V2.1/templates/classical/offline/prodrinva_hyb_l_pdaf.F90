!$Id: prodrinva_hyb_l_pdaf.F90 1075 2023-02-13 18:56:39Z lnerger $
...
!! weight gamma is applied.
!!
!! This routine is called by all filter processes.
!!
!! This template is for a diagonal observation error
!! covariance matrix with constant observation error
...
! ********************
  ...
  DO j = 1, rank
     DO i = 1, dim_obs_l
        C_l(i, j) = gamma * ivariance_obs * weight(i) * A_l(i, j)
     END DO
  END DO
...
END SUBROUTINE prodRinvA_hyb_l_pdaf
