...
! NetCDF output files for the Lorenz 05b model
...
!
! !INTERFACE:
  SUBROUTINE init_netcdf(step, time, dt, forcing, k_avg, dim, state)
...
! !ARGUMENTS:
    ...
    REAL, INTENT(IN)    :: forcing     ! Forcing variable of Lorenz 05b model
    INTEGER, INTENT(IN) :: k_avg       ! Averaging parameter for Lorenz 05b model
