...
# Name of executable
EXE="mpirun -np $NENS --oversubscribe ./pdaf_lorenz_96"

# General settings for all experiments
DEFAULTS="-total_steps 2 -step_null 1000 -dim_ens $NENS"
...
do
    $EXE $DEFAULTS -filtertype $FILTER -forget $FORGET -local_range 10 \
