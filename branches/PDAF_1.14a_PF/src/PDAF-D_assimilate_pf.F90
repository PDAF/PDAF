! Copyright (c) 2014-2018 Lars Nerger
!
...
!
!$Id: PDAF-D_assimilate_pf.F90 34 2018-04-09 13:10:26Z lnerger $
!BOP
!
! !ROUTINE: PDAF_assimilate_pf --- Interface to PDAF for PF
!
! !INTERFACE:
...
! is computed by calling PDAF_put_state_pf. Subsequently, 
...
! **********************************************
  ...
  IF (cnt_steps == nsteps) THEN
     IF (mype_world==0) WRITE(*,'(a, 5x, a)') 'PDAF', 'Perform assimilation with PDAF - PF'
