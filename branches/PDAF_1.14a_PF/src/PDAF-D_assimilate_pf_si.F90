...
!
!$Id: PDAF-D_assimilate_pf_si.F90 27 2018-03-09 20:04:05Z lnerger $
!BOP
!
! !ROUTINE: PDAF_assimilate_pf_si --- Interface to transfer state to PDAF
!
! !INTERFACE:
SUBROUTINE PDAF_assimilate_pf_si(outflag)
