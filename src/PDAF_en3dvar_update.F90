...
!
!> Control analysis update of EN3DVAR/ESTKF and EN3DVAR/LESTKF
!!
!! Routines to control the analysis update of ensemble 3DVAR
...
CONTAINS
!> Control analysis update of EN3DVAR/ESTKF
!!
!! Routine to control the analysis update of ensemble 3DVAR
!! using the ESTKF to update the ensemble perturbations. 
!!
!! The analysis is performend in the analysis routines for
!! En3D-Var and ESTKF called by the routine.
...
END SUBROUTINE PDAFen3dvar_update_estkf

!-------------------------------------------------------------------------------
!> Control analysis update of EN3DVAR/LESTK
!!
!! Routine to control the analysis update of ensemble 3DVAR
...
END SUBROUTINE PDAFen3dvar_update_lestkf

END MODULE PDAF_en3dvar_update
