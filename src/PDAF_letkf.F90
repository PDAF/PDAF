...
!> PDAF_letkf_set_iparam --- Set integer parameter specific for LETKF filter
!!
!! LETKF-specific initialization of integer parameters
!!
!!    ! This is a core routine of PDAF and !
!!    ! should not be changed by the user  !
!!
...
!-------------------------------------------------------------------------------
!> PDAF_letkf_set_rparam --- Set real parameter specific for LETKF filter
!!
!! LETKF-specific initialization of real parameters
!!
!!    ! This is a core routine of PDAF and
!!      should not be changed by the user  !
!!
