...
!
!
!> Interface to PDAF for NETF
!!
!! __Revision history:__
!! * 2014-05 - Paul Kirchgessner - Initial code based on ETKF
!! * Other revisions - see repository log
!!
MODULE PDAFassimilate_netf

CONTAINS

!> Interface to PDAF for NETF for online coupling
!!
...
!! is computed by calling PDAF_put_state_netf. Subsequently, 
...
!! * Other revisions - see repository log
!!
  SUBROUTINE PDAF_assim_offline_netf(U_init_dim_obs, U_obs_op, &
       U_init_obs, U_prepoststep, U_likelihood, outflag)
...
! ********************
  ...
  END SUBROUTINE PDAF_assim_offline_netf

END MODULE PDAFassimilate_netf
