! Copyright (c) 2014-2026 Lars Nerger
!
...
!> Interface to PDAF for PF for online coupling
!!
...
!! * Other revisions - see repository log
!!
  SUBROUTINE PDAF_assim_offline_pf(U_init_dim_obs, U_obs_op, &
       U_init_obs, U_prepoststep, U_likelihood, outflag)
...
! ********************
  ...
  END SUBROUTINE PDAF_assim_offline_pf
