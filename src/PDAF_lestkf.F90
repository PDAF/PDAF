...
!-------------------------------------------------------------------------------
!>  Print information on configuration of LESTKF
!!
!!  !  This is a core routine of PDAF and   !
!!  !   should not be changed by the user   !
!!
...
!! *  Other revisions - see repository log
!!
  SUBROUTINE PDAF_lestkf_config(subtype, verbose)
...
! *********************
  ...
  END SUBROUTINE PDAF_lestkf_config
...
!-------------------------------------------------------------------------------
!> Information output on options for LESTKF
!!
!! Subroutine to perform information output on options
!! available for the LESTKF filter.
!!
!! !  This is a core routine of PDAF and
!!    should not be changed by the user   !
!!
...
! *********************************************
       ...
       IF (filterpe) THEN
          ! Filter-specific part
          WRITE (*, '(a, 21x, a, F11.3, 1x, a)') 'PDAF', 'LESTKF analysis (3):', pdaf_time_tot(3), 's'
