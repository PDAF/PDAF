...
!   INTEGER,EXTERNAL :: iargc
  ...
  ! *** define interface ***
  INTERFACE PDAF_parse
    MODULE PROCEDURE PDAF_parse_int
    MODULE PROCEDURE PDAF_parse_real
    MODULE PROCEDURE PDAF_parse_string
    MODULE PROCEDURE PDAF_parse_logical
  END INTERFACE
...
!!
  SUBROUTINE PDAF_parse_int(handle, intvalue)
...
!> Parse a real value
!!
  SUBROUTINE PDAF_parse_real(handle, realvalue)
...
!> Parse a string
!!
  SUBROUTINE PDAF_parse_string(handle, charvalue)
...
!-----------------------------------------------
!> Parse a logical variable
!!
  SUBROUTINE PDAF_parse_logical(handle, logvalue)
