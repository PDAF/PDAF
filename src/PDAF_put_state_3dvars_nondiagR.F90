...
!! * Other revisions - see repository log
!!
SUBROUTINE PDAF3_put_state_3dvar_nondiagR(collect_state_pdaf, &
...
END SUBROUTINE PDAF3_put_state_3dvar_nondiagR
...
END SUBROUTINE PDAF3_put_state_en3dvar_estkf_nondiagR
...
!! * Other revisions - see repository log
!!
SUBROUTINE PDAF3_put_state_en3dvar_lestkf_nondiagR(collect_state_pdaf, &
     init_dim_obs_pdafomi, obs_op_pdafomi, prodRinvA_pdafomi, &
     cvt_ens_pdaf, cvt_adj_ens_pdaf, obs_op_lin_pdafomi, obs_op_adj_pdafomi, &
...
END SUBROUTINE PDAF3_put_state_en3dvar_lestkf_nondiagR
...
!! * Other revisions - see repository log
!!
SUBROUTINE PDAF3_put_state_hyb3dvar_estkf_nondiagR(collect_state_pdaf, &
     init_dim_obs_pdafomi, obs_op_pdafomi, prodRinvA_pdafomi, &
...
END SUBROUTINE PDAF3_put_state_hyb3dvar_estkf_nondiagR
...
!! * Other revisions - see repository log
!!
SUBROUTINE PDAF3_put_state_hyb3dvar_lestkf_nondiagR(collect_state_pdaf, &
     init_dim_obs_pdafomi, obs_op_pdafomi, prodRinvA_pdafomi, &
     cvt_ens_pdaf, cvt_adj_ens_pdaf, cvt_pdaf, cvt_adj_pdaf, &
     obs_op_lin_pdafomi, obs_op_adj_pdafomi, &
     prodRinvA_l_pdafomi, init_n_domains_pdaf, init_dim_l_pdaf, init_dim_obs_l_pdafomi, &
