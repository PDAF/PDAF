...
!
!
!> Interface to PDAF for hyb3DVAR/ESTKF
!!
...
!> Interface to PDAF for hyb3DVAR/ESTKF for offline mode
!!
...
!! * Other revisions - see repository log
!!
  SUBROUTINE PDAF_assim_offline_hyb3dvar_estkf(U_init_dim_obs, U_obs_op, &
...
! ********************
  ...
  END SUBROUTINE PDAF_assim_offline_hyb3dvar_estkf
