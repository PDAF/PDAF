...
!
!
!> Interfaces to PDAF for fully-parallel mode for PDAF-OMI
!!
...
!!
MODULE PDAFomi_assimilate_3dvars
...
! **************************************************
  ...
  IF (debug>0) &
       WRITE (*,*) '++ PDAFomi-debug: ', debug, 'PDAFomi_assimilate_en3dvar_lestkf -- START'
...
! *******************************************
  ...
  IF (debug>0) &
       WRITE (*,*) '++ PDAFomi-debug: ', debug, 'PDAFomi_assimilate_en3dvar_lestkf -- END'
...
END MODULE PDAFomi_assimilate_3dvars
