...
!
!
!> Interface to PDAF for ETKF
!!
!! __Revision history:__
!! * 2013-08 - Lars Nerger - Initial code
!! * Other revisions - see repository log
!!
MODULE PDAFassimilate_etkf

CONTAINS

!> Interface to PDAF for ETKF for online coupling
!!
...
!! * Other revisions - see repository log
!!
SUBROUTINE PDAF_assim_offline_etkf(U_init_dim_obs, U_obs_op, &
     U_init_obs, U_prepoststep, U_prodRinvA, U_init_obsvar, outflag)
...
! ********************
  ...
  END SUBROUTINE PDAF_assim_offline_etkf

END MODULE PDAFassimilate_etkf
