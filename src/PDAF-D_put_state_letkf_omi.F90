...
!
!$Id: PDAF-D_put_state_letkf_omi.F90 374 2020-02-26 12:49:56Z lnerger $
!BOP
!
! !ROUTINE: PDAF_put_state_letkf_omi --- Interface to transfer state to PDAF
!
! !INTERFACE:
SUBROUTINE PDAF_put_state_letkf_omi(collect_state_pdaf, init_dim_obs_f_pdaf, obs_op_f_pdaf, &
