...
!
!$Id: PDAF-D_put_state_lknetf_si.F90 1681 2016-12-11 12:43:58Z lnerger $
!BOP
!
! !ROUTINE: PDAF_put_state_lknetf_si --- Interface to transfer state to PDAF
!
! !INTERFACE:
SUBROUTINE PDAF_put_state_lknetf_si(outflag)
...
! **************************************************
  ...
  CALL PDAF_put_state_lknetf(collect_state_pdaf, init_dim_obs_f_pdaf, &
