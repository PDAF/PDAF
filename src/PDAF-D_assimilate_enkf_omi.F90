...
!
!$Id: PDAF-D_assimilate_enkf_omi.F90 374 2020-02-26 12:49:56Z lnerger $
!BOP
!
! !ROUTINE: PDAF_assimilate_enkf_omi --- Interface to transfer state to PDAF
!
! !INTERFACE:
SUBROUTINE PDAF_assimilate_enkf_omi(collect_state_pdaf, distribute_state_pdaf, &
