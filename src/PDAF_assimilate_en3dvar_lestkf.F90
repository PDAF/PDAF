...
!!
MODULE PDAFassimilate_en3dvar_lestkf

CONTAINS

!> Interface to PDAF for En3DVAR/LESTKF for online coupling
!!
...
!!
  SUBROUTINE PDAF_assimilate_en3dvar_lestkf(U_collect_state, U_distribute_state, &
    ...
    USE PDAFput_state_en3dvar_lestkf, &
         ONLY: PDAF_put_state_en3dvar_lestkf
...
!! * Other revisions - see repository log
!!
  SUBROUTINE PDAF_assim_offline_en3dvar_lestkf(U_init_dim_obs, U_obs_op, &
...
! ********************
  ...
  END SUBROUTINE PDAF_assim_offline_en3dvar_lestkf

END MODULE PDAFassimilate_en3dvar_lestkf
