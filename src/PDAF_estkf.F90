...
!> PDAF_estkf_set_iparam --- Set integer parameter specific for ESTKF filter
!!
!! ESTKF-specific initialization of integer parameter
!!
!!    ! This is a core routine of PDAF and !
!!    ! should not be changed by the user  !
!!
...
!-------------------------------------------------------------------------------
!> PDAF_estkf_set_rparam --- Set real parameter specific for ESTKF filter
!!
!! ESTKF-specific initialization of real parameter
!!
!!    ! This is a core routine of PDAF and !
!!    ! should not be changed by the user  !
!!
