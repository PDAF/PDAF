...
!
!$Id: PDAF-D_assimilate_lnetf_omi.F90 374 2020-02-26 12:49:56Z lnerger $
!BOP
!
! !ROUTINE: PDAF_assimilate_lnetf_omi --- Interface to transfer state to PDAF
!
! !INTERFACE:
SUBROUTINE PDAF_assimilate_lnetf_omi(collect_state_pdaf, distribute_state_pdaf, &
...
! ! Names of external subroutines 
  ...
  EXTERNAL :: PDAFomi_init_obs_f_cb, & ! Initialize full observation vector
       ...
       PDAFomi_likelihood_l_cb         ! Provide product R^-1 A on local analysis domain

! !CALLING SEQUENCE:
! Called by: model code  
! Calls: PDAF_assimilate_lnetf
!EOP
