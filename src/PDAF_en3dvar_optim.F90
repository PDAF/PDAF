...
!! * LBFGS: PDAF_en3dvar_optim_lbfgs
!! * CGplus: PDAF_en3dvar_optim_cgplus
!! * plain CG: PDAF_en3dvar_optim_cg
!!
!! In addition routine evaluation the cost function are included:
!! * For LBFGS & CGplus: PDAF_en3dvar_costf_cg_cvt
!! * For plain CG: PDAF_en3dvar_costf_cg_cvt
!!
MODULE PDAF_en3dvar_optim
...
! **********************
  ...
  IF (debug>0) &
       WRITE (*,*) '++ PDAF-debug: ', debug, 'PDAF_en3dvar_optim_LBFGS -- START'
  ...
  IF (debug>0) THEN
     WRITE (*,*) '++ PDAF-debug PDAF_en3dvar_optim_LBFGS', debug, &
          'Solver config: m    ', m
     WRITE (*,*) '++ PDAF-debug PDAF_en3dvar_optim_LBFGS', debug, &
...
! ********************
  ...
  IF (debug>0) &
       WRITE (*,*) '++ PDAF-debug: ', debug, 'PDAF_en3dvar_optim_LBFGS -- END'

END SUBROUTINE PDAF_en3dvar_optim_lbfgs

!-------------------------------------------------------------------------------
!> Optimization for CG+ for En3dVar
!!
...
!-------------------------------------------------------------------------------
!> Optimization with parallelized CG for En3DVar
!!
