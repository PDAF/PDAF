...
!> PDAF_netf_set_iparam --- Set integer parameter specific for NETF
!!
!! NETF-specific initialization of integer parameter
!!
!!    ! This is a core routine of PDAF and !
!!    ! should not be changed by the user  !
!!
...
!-------------------------------------------------------------------------------
!> PDAF_netf_set_rparam --- Set real parameter specific for NETF
!!
!! NETF-specific initialization of real parameter
!!
!!    ! This is a core routine of PDAF and !
!!    ! should not be changed by the user  !
!!
