...
!BOP
!
! !ROUTINE: PDAF_put_state_seik_omi --- Interface to transfer state to PDAF
!
! !INTERFACE:
SUBROUTINE PDAF_put_state_seik_omi(collect_state_pdaf, init_dim_obs_pdaf, obs_op_pdaf, &
