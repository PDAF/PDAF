...
!
! !INTERFACE:
SUBROUTINE PDAFomilocal_assimilate(collect_state_pdaf, distribute_state_pdaf, &
          init_dim_obs_f_pdaf, obs_op_f_pdaf, prepoststep_pdaf, init_n_domains_pdaf, &
          init_dim_l_pdaf, init_dim_obs_l_pdaf, next_observation_pdaf, outflag)
...
! **************************************************
  ...
  IF (TRIM(filterstr) == 'LSEIK') THEN
     CALL PDAF_assimilate_lseik(collect_state_pdaf, distribute_state_pdaf, &
          ...
          init_dim_l_pdaf, init_dim_obs_l_pdaf, PDAFlocal_g2l_callback, PDAFlocal_l2g_callback, &
  ...
  ELSE IF (TRIM(filterstr) == 'LKNETF') THEN
     CALL PDAF_assimilate_lknetf(collect_state_pdaf, distribute_state_pdaf, &
          ...
          PDAFlocal_g2l_callback, PDAFlocal_l2g_callback, PDAFomi_g2l_obs_cb, PDAFomi_init_obsvar_cb, &
...
END SUBROUTINE PDAFomilocal_assimilate
