...
!> PDAF_lenkf_set_iparam --- Set integer parameter specific for LEnKF filter
!!
!! LEnKF-specific initialization of integer parameter
!!
!!    ! This is a core routine of PDAF and !
!!    ! should not be changed by the user  !
!!
...
!-------------------------------------------------------------------------------
!> PDAF_lenkf_set_rparam --- Set real parameter specific for LEnKF filter
!!
!! LEnKF-specific initialization of real parameter
!!
!!    ! This is a core routine of PDAF and !
!!    ! should not be changed by the user  !
!!
