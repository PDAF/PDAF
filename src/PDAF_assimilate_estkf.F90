...
!!
MODULE PDAFassimilate_estkf

CONTAINS

!> Interface to PDAF for ESTKF for online coupling
!!
...
!! * Other revisions - see repository log
!!
  SUBROUTINE PDAF_assim_offline_estkf(U_init_dim_obs, U_obs_op, &
       U_init_obs, U_prepoststep, U_prodRinvA, U_init_obsvar, outflag)
...
! ********************
  ...
  END SUBROUTINE PDAF_assim_offline_estkf

END MODULE PDAFassimilate_estkf
