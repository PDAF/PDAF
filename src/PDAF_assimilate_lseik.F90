...
!!
MODULE PDAFassimilate_lseik

CONTAINS

!> Interface to PDAF for LSEIK for online coupling
!!
...
!! * Other revisions - see repository log
!!
  SUBROUTINE PDAF_assim_offline_lseik(U_init_dim_obs, U_obs_op, &
       U_init_obs, U_init_obs_l, U_prepoststep, U_prodRinvA_l, U_init_n_domains_p, &
       U_init_dim_l, U_init_dim_obs_l, U_g2l_state, U_l2g_state, U_g2l_obs, &
       U_init_obsvar, U_init_obsvar_l, outflag)
...
! ********************
  ...
  END SUBROUTINE PDAF_assim_offline_lseik

END MODULE PDAFassimilate_lseik
