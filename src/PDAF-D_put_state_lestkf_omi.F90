...
!BOP
!
! !ROUTINE: PDAF_put_state_lestkf_omi --- Interface to transfer state to PDAF
!
! !INTERFACE:
SUBROUTINE PDAF_put_state_lestkf_omi(collect_state_pdaf, init_dim_obs_f_pdaf, obs_op_f_pdaf, &
