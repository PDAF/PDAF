...
! *********************
    ...
    writeout: IF (verbose > 0) THEN
       ...
       ELSE IF (subtype == 11) THEN
          WRITE (*, '(a, 12x, a)') 'PDAF', '--> LSEIK-EnOI (fixed ensemble perturbations)'
       END IF
       WRITE(*, '(a, 10x, a, i3)') &
...
! *********************************************
       ...
       IF (.not.offline_mode) THEN
          ...
          END IF
          WRITE (*, '(a, 14x, a, F11.3, 1x, a)') 'PDAF', 'MPI communication in PDAF (4):', pdaf_time_tot(4), 's'
          IF (.not.filterpe) WRITE (*, '(a, 7x, a)') 'PDAF', &
               'Note: for filterpe=F, the time (2) includes the wait time for the analysis step'
       END IF
       ...
       IF (filterpe) THEN
          ! Filter-specific part
          WRITE (*, '(a, 22x, a, F11.3, 1x, a)') 'PDAF', 'LSEIK analysis (3):', pdaf_time_tot(3), 's'
          ...
          IF (subtype_filter /= 1) THEN
             WRITE (*, '(a, 16x, a, F11.3, 1x, a)') 'PDAF', 'ensemble transformation (13):', pdaf_time_tot(13), 's'
          END IF
...
! *****************************************
       ...
       IF (filterpe) THEN
          ...
          WRITE (*, '(a, 26x, a, F11.3, 1x, a)') 'PDAF', 'init_obs_l_pdaf (47):', pdaf_time_tot(47), 's'
          WRITE (*, '(a, 19x, a, F11.3, 1x, a)') 'PDAF', 'local state analysis (12):', pdaf_time_tot(12), 's'
          WRITE (*, '(a, 29x, a, F11.3, 1x, a)') 'PDAF', 'compute Ainv (16):', pdaf_time_tot(16), 's'
          WRITE (*, '(a, 28x, a, F11.3, 1x, a)') 'PDAF', 'init innovation (20):', pdaf_time_tot(20), 's'
          WRITE (*, '(a, 29x, a, F11.3, 1x, a)') 'PDAF', 'prodRinvA_pdaf (48):', pdaf_time_tot(48), 's'
          WRITE (*, '(a, 30x, a, F11.3, 1x, a)') 'PDAF', 'complete Ainv (21):', pdaf_time_tot(21), 's'
          IF (subtype_filter /= 1) THEN
             WRITE (*, '(a, 18x, a, F11.3, 1x, a)') 'PDAF', 'get state weight vector (22):', pdaf_time_tot(22), 's'
             WRITE (*, '(a, 29x, a, F11.3, 1x, a)') 'PDAF', 'update state (23):', pdaf_time_tot(23), 's'
             WRITE (*, '(a, 16x, a, F11.3, 1x, a)') 'PDAF', 'ensemble transformation (13):', pdaf_time_tot(13), 's'
             WRITE (*, '(a, 21x, a, F11.3, 1x, a)') 'PDAF', 'prepare ens. weights (24):', pdaf_time_tot(24), 's'
             WRITE (*, '(a, 33x, a, F11.3, 1x, a)') 'PDAF', 'SQRT(Ainv) (32):', pdaf_time_tot(32), 's'
             WRITE (*, '(a, 25x, a, F11.3, 1x, a)') 'PDAF', 'compute C^T OmegaT (34):', pdaf_time_tot(34), 's'
             WRITE (*, '(a, 28x, a, F11.3, 1x, a)') 'PDAF', 'update ensemble (18):', pdaf_time_tot(18), 's'
          ELSE
             WRITE (*, '(a, 17x, a, F11.3, 1x, a)') 'PDAF', 'compute ensemble weights (17):', pdaf_time_tot(17), 's'
             WRITE (*, '(a, 20x, a, F11.3, 1x, a)') 'PDAF', 'get state weight vector (22):', pdaf_time_tot(22), 's'
             WRITE (*, '(a, 18x, a, F11.3, 1x, a)') 'PDAF', 'complete transform matrix (23):', pdaf_time_tot(23), 's'
!            WRITE (*, '(a, 31x, a, F11.3, 1x, a)') 'PDAF', 'SQRT(Ainv) (32):', pdaf_time_tot(32), 's'
!            WRITE (*, '(a, 23x, a, F11.3, 1x, a)') 'PDAF', 'compute C^T OmegaT (34):', pdaf_time_tot(34), 's'
             WRITE (*, '(a, 24x, a, F11.3, 1x, a)') 'PDAF', 'update ensemble (18):', pdaf_time_tot(18), 's'
          END IF
          WRITE (*, '(a, 24x, a, F11.3, 1x, a)') 'PDAF', 'local to global (14):', pdaf_time_tot(14), 's'
