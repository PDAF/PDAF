...
!
!
!> Interfaces to PDAF for fully-parallel mode for ensemble filters
!!
...
!!
MODULE PDAFlocalomi_assimilate_ens

CONTAINS

!-------------------------------------------------------------------------------
!> Interface to transfer state to PDAF for local filters with diagonal R
!!
!! __Revision history:__
...
END MODULE PDAFlocalomi_assimilate_ens
