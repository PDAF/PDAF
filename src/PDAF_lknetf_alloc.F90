...
!
!$Id: PDAF-D_letkf_alloc.F90 1812 2017-08-12 16:38:54Z lnerger $
!BOP
!
! !ROUTINE: PDAF_lknetf_alloc --- PDAF-internal initialization of LKNETF
!
! !INTERFACE:
SUBROUTINE PDAF_lknetf_alloc(subtype, outflag)
