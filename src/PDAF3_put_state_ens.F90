...
!! * Other revisions - see repository log
!!
SUBROUTINE PDAF3_put_state_generate_obs(collect_state_pdaf, init_dim_obs_pdaf, &
...
! **************************************************
  ...
  CALL PDAF_put_state_generate_obs(collect_state_pdaf, init_dim_obs_pdaf, obs_op_pdaf, &
