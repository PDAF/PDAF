...
!!
MODULE PDAFassimilate_seik

CONTAINS

!> Interface to PDAF for SEIK for online coupling
!!
...
! ********************
  ...
  END SUBROUTINE PDAF_assim_offline_seik

END MODULE PDAFassimilate_seik
