...
!> Interface to PDAF for LEnKF for online coupling
!!
...
!! * Other revisions - see repository log
!!
SUBROUTINE PDAF_assim_offline_lenkf(U_init_dim_obs, U_obs_op,  &
...
! ********************
  ...
  END SUBROUTINE PDAF_assim_offline_lenkf
