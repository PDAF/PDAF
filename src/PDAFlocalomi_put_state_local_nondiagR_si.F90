...
!BOP
!
! !ROUTINE: PDAFlocalomi_put_state_local_nondiagR_si --- Interface to transfer state to PDAF
!
! !INTERFACE:
SUBROUTINE PDAFlocalomi_put_state_local_nondiagR_si(outflag)
...
! Calls: PDAFlocalomi_put_state_local_nondiagR
!EOP
...
! **************************************************
  ...
  CALL PDAFlocalomi_put_state_local_nondiagR(collect_state_pdaf, &
...
END SUBROUTINE PDAFlocalomi_put_state_local_nondiagR_si
