...
!BOP
!
! !ROUTINE: PDAFomi_assimilate_global_si --- Interface to transfer state to PDAF
!
! !INTERFACE:
SUBROUTINE PDAFomi_assimilate_global_si(outflag)
...
! Calls: PDAFomi_assimilate_global
!EOP
