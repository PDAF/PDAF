...
!
!$Id: PDAF-D_put_state_enkf_omi.F90 374 2020-02-26 12:49:56Z lnerger $
!BOP
!
! !ROUTINE: PDAF_put_state_enkf_omi --- Interface to transfer state to PDAF
!
! !INTERFACE:
SUBROUTINE PDAF_put_state_enkf_OMI(collect_state_pdaf, init_dim_obs_pdaf, obs_op_pdaf, &
