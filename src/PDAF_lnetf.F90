...
! *********************************************
       ...
       IF (filterpe) THEN
          ! Filter-specific part
          WRITE (*, '(a, 10x, a, 12x, F11.3, 1x, a)') 'PDAF', 'LNETF analysis (3):', pdaf_time_tot(3), 's'
...
!              WRITE (*, '(a, 14x, a, 7x, F11.3, 1x, a)') 'PDAF', 'inflate ensemble (14):', pdaf_time_tot(14), 's'
!        WRITE (*, '(a, 14x, a, F11.3, 1x, a)')  'PDAF', 'compute HX for filter (12):', pdaf_time_tot(12), 's'
          WRITE (*, '(a, 14x, a, 1x, F11.3, 1x, a)') 'PDAF', 'generate random matrix (33):', pdaf_time_tot(33), 's'
          WRITE (*, '(a, 12x, a, 7x, F11.3, 1x, a)') 'PDAF', 'local analysis loop (8):', pdaf_time_tot(8), 's'
          WRITE (*, '(a, 14x, a, 10x, F11.3, 1x, a)') 'PDAF', 'global to local (10):', pdaf_time_tot(15), 's'
          WRITE (*, '(a, 14x, a, 4x, F11.3, 1x, a)') 'PDAF', 'localize observations (11):', pdaf_time_tot(11), 's'
          ...
          WRITE (*, '(a, 14x, a, 11x, F11.3, 1x, a)') 'PDAF', 'local analysis (12):', pdaf_time_tot(12), 's'
          WRITE (*, '(a, 16x, a, 9x, F11.3, 1x, a)') 'PDAF', 'compute matrix A (16):', pdaf_time_tot(16), 's'
          WRITE (*, '(a, 18x, a, 1x, F11.3, 1x, a)') 'PDAF', 'compute particle weights (20):', pdaf_time_tot(20), 's'
          WRITE (*, '(a, 20x, a, 8x, F11.3, 1x, a)') 'PDAF', 'likelihood_l_pdaf (48):', pdaf_time_tot(48), 's'
          WRITE (*, '(a, 18x, a, 15x, F11.3, 1x, a)') 'PDAF', 'complete A (21):', pdaf_time_tot(21), 's'
          WRITE (*, '(a, 16x, a, 8x, F11.3, 1x, a)') 'PDAF', 'compute transform (17):', pdaf_time_tot(17), 's'
          WRITE (*, '(a, 18x, a, 17x, F11.3, 1x, a)') 'PDAF', 'SVD of A (22):', pdaf_time_tot(22), 's'
!        WRITE (*, '(a, 18x, a, 7x, F11.3, 1x, a)') 'PDAF', 'product of T and A (32):', pdaf_time_tot(32), 's'
!        WRITE (*, '(a, 18x, a, 6x, F11.3, 1x, a)') 'PDAF', 'multiply with svals (33):', pdaf_time_tot(33), 's'
!        IF (type_forget==2 .OR. type_forget==3) &
!             WRITE (*, '(a, 18x, a, 4x, F11.3, 1x, a)') 'PDAF', 'inflate post ensemble (34):', pdaf_time_tot(34), 's'
!        WRITE (*, '(a, 18x, a, 6x, F11.3, 1x, a)') 'PDAF', 'apply random matrix (35):', pdaf_time_tot(35), 's'
          ...
          IF (dim_lag >0) &
               WRITE (*, '(a, 14x, a, 8x, F11.3, 1x, a)') 'PDAF', 'perform smoothing (15):', pdaf_time_tot(15), 's'
          WRITE (*, '(a, 12x, a, 4x, F11.3, 1x, a)') 'PDAF', 'add noise to ensemble (19):', pdaf_time_tot(19), 's'
