...
!> Interface to PDAF for ENSRF for online coupling
!!
...
!! is computed by calling PDAF_put_state_ensrf. Subsequently, 
...
!! * Other revisions - see repository log
!!
SUBROUTINE PDAF_assim_offline_ensrf(U_init_dim_obs, U_obs_op,  &
     U_init_obs, U_init_obsvars, U_localize_covar_serial, U_prepoststep, outflag)
...
! ********************
  ...
  END SUBROUTINE PDAF_assim_offline_ensrf
